...
data1,target1=GenerateData1D(-3,3,input_size,function=np.cos)

plt.scatter(data1,target1,color='blue',marker='.',s=0.5)
plt.legend(['y=cos(x)'],loc='best',fontsize=12,markerscale=5)
plt.show()
...
plt.legend(['y=cos(x)','Encoder X'],loc='best',fontsize=12,markerscale=5)
plt.show()
