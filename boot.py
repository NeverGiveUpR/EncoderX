...
data2=data_loader(r'C:\Users\29915\Desktop\final3\Implicit_polynomial\CNN\code\airpane\boot0.csv')
...
net=IPEncoder(n_hidden1,n_hidden2,n_hidden3,n_hidden4,n_hidden5,n_hidden6,n_hidden7,n_hidden8,n_hidden9,n_hidden10,n_hidden11,n_hidden12,n_hidden13,n_hidden14,n_hidden15).cuda()

optimizer1=torch.optim.Adam(net.parameters(),lr=LR1)


scheduler1=lr_scheduler.StepLR(optimizer1,step_size=1000,gamma=0.9)
...
target1=0.05*torch.ones([data_size])
target2=torch.zeros([data_size])
target3=-0.05*torch.ones([data_size])
...
for epoch in range(EPOCH):
    ...
    print('|Epoch:',epoch,'|Loss:%8f'%loss.cpu().data.numpy())
